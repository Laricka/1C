...
Процедура Печать(ТабДок, Ссылка) Экспорт
	...
	Макет = Документы.ОформлениеПосылки.ПолучитьМакет("Печать");
	Запрос = Новый Запрос;
	Запрос.Текст =
	"ВЫБРАТЬ
	|	ОформлениеПосылки.Дата,
	|	ОформлениеПосылки.Номер,
	|	ОформлениеПосылки.Сотрудник,
	|	ОформлениеПосылки.ТЧ1.(
	|		НомерСтроки,
	|		Клиент,
	|		Посылка,
	|		ДатаОтправки,
	...
	|	)
	|ИЗ
	|	Документ.ОформлениеПосылки КАК ОформлениеПосылки
	|ГДЕ
	|	ОформлениеПосылки.Ссылка В (&Ссылка)";
